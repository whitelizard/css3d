...
export class Tool3d extends Component {
  ...
  goDown = () => {
    console.log(this.upper.style);
    this.upper.style.transform = 'translate3d(0,180,0)';
    this.upper2.style.transform = 'translate3d(0,210,0)';
    // this.upper.style.setProperty('transform', 'translate3d(0,180,0)');
    // this.upper2.style.setProperty('transform', 'translate3d(0,210,0)');
    //   .y(180)
    //   .update();
    // this.upper2
    //   .y(210)
  ...
  goUp = () => {
    this.upper.style.setProperty('transform', 'translate3d(0,-20,0)');
    this.upper2.style.setProperty('transform', 'translate3d(0,10,0)');
    this.upper.style.transform = 'translate3d(0,-20,0)';
    this.upper2.style.transform = 'translate3d(0,10,0)';
    // this.upper
    //   .y(-20)
    //   .update();
    // this.upper2
