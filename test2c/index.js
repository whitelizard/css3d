...
export class World3d extends Component {
  goDown = () => {
    // this.box.forEach(b => b.y(uPos + 130).update());
    console.log(this.moving.children);
    // const len = this.moving.children.length;
    this.moving.style.transform = 'translate3d(0px, 130px, 0px)';
    // for (let i = 0; i < len; ++i) {
    //   this.moving.children[i].style.setProperty(
    //     '--transform',
  ...
  goUp = () => {
    ...
    // this.box.forEach(b => b.y(uPos).update());
  };
  componentDidMount() {}
